...
public class BlockRedstoneStoper extends BlockRedstoneRepeater{

    public BlockRedstoneStoper(boolean powered)
    {
        super(powered);
    ...
    protected int calculateInputStrength(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        else
        {
            ...
            return  Math.max(i, iblockstate.getBlock() == Blocks.REDSTONE_WIRE ? ((Integer)iblockstate.getValue(BlockRedstoneWire.POWER)).intValue() : 0)>0 ? 0 :15;
        }
    }
    /**
    ...
    {
        return new ItemBlock(EasyRails.UnpoweredStoper);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(EasyRails.UnpoweredStoper);
    }
