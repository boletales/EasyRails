...
public class BlockLongRepeater extends BlockRedstoneRepeater{

    public BlockLongRepeater(boolean powered)
    {
        super(powered);
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return EasyRails.UnpoweredLongRepeater.getDefaultState().withProperty(FACING, enumfacing).withProperty(DELAY, integer).withProperty(LOCKED, obool);
    }
    /**
    ...
    {
        return new ItemBlock(EasyRails.UnpoweredLongRepeater);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(EasyRails.UnpoweredLongRepeater);
    }
