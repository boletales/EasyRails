...
public class TileEntityHopperPlus extends TileEntityLockableLoot implements IHopper, ITickable, IInteractionObject
{
    ...
    {
        //if (HopperPlusInventoryCodeHooks.insertHook(this)) { return true; }
    ...
    {
        EnumFacing enumfacing = BlockHopper.getFacing(((TileEntity)hopper).getBlockMetadata()).getOpposite();
        Boolean ret = HopperPlusInventoryCodeHooks.extractHook(hopper,enumfacing);
            ...
            if (flag)
            {
                if (flag1 && destination instanceof TileEntityHopper)
                {
                    ...
                    if (!tileentityhopper1.mayTransfer())
                    {
                        ...
                        {
                            TileEntityHopperPlus tileentityhopper = (TileEntityHopperPlus)source;
