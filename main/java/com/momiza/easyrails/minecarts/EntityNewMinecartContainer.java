...
public abstract class EntityNewMinecartContainer extends EntityNewMinecart implements ILockableContainer
{


    private NonNullList<ItemStack> minecartContainerItems = NonNullList.<ItemStack>withSize(81, ItemStack.EMPTY);
    /**
