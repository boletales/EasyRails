...
public class ModelNewMinecartColor extends ModelBase
{
    public ModelRenderer[] sideModels = new ModelRenderer[7];

    public ModelNewMinecartColor()
    {
        this.sideModels[0] = new ModelRenderer(this, 0, 10);
        this.sideModels[1] = new ModelRenderer(this, 22, 4);
        this.sideModels[2] = new ModelRenderer(this, 22, 4);
        this.sideModels[3] = new ModelRenderer(this, 22, 4);
        this.sideModels[4] = new ModelRenderer(this, 22, 4);
        ...
        this.sideModels[1].addBox( -8.0F, -6.0F, 0.1F, 16, 3, 1, 0.0F);
        this.sideModels[1].setRotationPoint(-9.0F, 4.0F, 0.0F);
        this.sideModels[2].addBox( -8.0F, -6.0F, 0.1F, 16, 3, 1, 0.0F);
        this.sideModels[2].setRotationPoint(9.0F, 4.0F, 0.0F);
        this.sideModels[3].addBox(-10.0F, -6.0F, 0.1F, 20, 3, 1, 0.0F);
        this.sideModels[3].setRotationPoint(0.0F, 4.0F, -7.0F);
        this.sideModels[4].addBox(-10.0F, -6.0F, 0.1F, 20, 3, 1, 0.0F);
